...
const scenes = [
  ...
  {name: 'TeeTLSExecution', duration: 420, component: TeeTLSExecution},
  {name: 'ProofStorage', duration: 300, component: ProofStorage},
  {name: 'Verification', duration: 360, component: Verification},
  {name: 'Verdict', duration: 240, component: Verdict},
  {name: 'BuiltOnZeroGClose', duration: 180, component: BuiltOnZeroGClose},
];
